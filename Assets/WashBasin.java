...
public class WashBasin implements DesignElement{
    private static final int DEFAULT_SINK_WIDTH = 44;
    ...
    private static final int DEFAULT_BASIN_DIAMETER = 8;
    ...
    private int basindiameter = DEFAULT_BASIN_DIAMETER;
    ...
    public void draw(Graphics2D g) {
        ...
        // Draw faucet
        g.fillRect(-sinkWidth/2 + sinkWidth / 2 - faucetWidth / 2, -sinkHeight/2, faucetWidth, faucetHeight);

        //Draw Basin
        g.drawOval(-basindiameter/2, -basindiameter/2, basindiameter , basindiameter);
    ...
    public void resize(double scale) {
        ...
        basindiameter = (int) (scale * DEFAULT_BASIN_DIAMETER);
    }
